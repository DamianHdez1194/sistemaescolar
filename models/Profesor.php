 ...
 * @property Coordinacion $fkCoordinacion
...
class Profesor extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['Fk_coordinacion'], 'exist', 'skipOnError' => true, 'targetClass' => Coordinacion::class, 'targetAttribute' => ['Fk_coordinacion' => 'ID']],
     ...
     *
     * @return \yii\db\ActiveQuery|\app\models\query\CoordinacionQuery
     */
    public function getFkCoordinacion()
    {
        return $this->hasOne(Coordinacion::class, ['ID' => 'Fk_coordinacion']);
    }
