...
<div class="col-lg-12 mb-4">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-2">
            <h6 class="m-0 font-weight-bold text-primary">Coordinación</h6>
        </div>
        <div class="card-body">
            <p>
            <?php 
                echo Html::button('<i class="fa fa-plus"></i>', 
                ['value'=>Url::to(['coordinacion/create']),
...
<?php 
                $gridColumns = [
                    ...
                    [
                        'attribute'=>'Nombre',
                        'header'=>'Nombre de la coordinación',
                        'vAlign'=>'middle',
                    ],
                        ...
                        'buttons' => [
                            'ver' => function ($url, $dataProvider) {
                                return Html::button('<i class="fa fa-fw fa-eye"></i>', 
                                         ['value'=>Url::to(['coordinacion/view', 'ID'=> Util::encrypt_decryptID($dataProvider->ID,1)]), 
                    ...
                    [
                        ...
                        'buttons' => [
                            ...
                            ['value'=>Url::to(['coordinacion/update', 'ID'=> Util::encrypt_decryptID($dataProvider->ID,1)]),
                            'class' => 'btn btn-default btn-xs custom_button'
                            ]);
                            },
                        ],
            ...
            'panel' => [
                        'heading'=>'<h6 style="color:white;text-align:center">COORDINACIÓN</h6>',
                        'type'=>'primary',
                        'footer'=>false,
                        'before'=>false,
                            ],
